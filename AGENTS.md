...
2026-09-21 使用者確認逐卡水彩插圖並要求正式整合，以文字閱讀為優先。卡片插圖與 responsive 版面見 [CARD_ILLUSTRATIONS_20260921.md](docs/CARD_ILLUSTRATIONS_20260921.md)；這是本次新增的明確視覺授權，其餘頁首、四分頁及既有操作仍保留。
