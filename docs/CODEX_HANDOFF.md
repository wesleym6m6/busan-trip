...
2026-09-22 使用者授權增加卡片互動：按壓底色／內框、原生 CSS grid 展開收合、一次性的插圖浮現。`CardMotionProvider` 只管理頁面生命週期的動態偏好與已看過插圖；詳情收合採 inert／aria-hidden。156 次收合卡片幾何與原版完全一致，74 次手機尺寸展開檢查、快速反向、鍵盤與減少動態通過。詳見 [CARD_MOTION_20260922.md](CARD_MOTION_20260922.md)。本次僅本機預覽，未發布。

使用者隨後要求直接上線，卡片互動已發布：來源 `7ddca7bf827c34f6974fff28966a13e28e2bd011`，Run `35627597788` 成功。37 個正式檔案位元比對，以及正式站 156 次收合幾何、74 次手機尺寸展開、反向收合、鍵盤、減少動態與插圖不重播檢查均通過；詳見 DEPLOYMENT.md 最新紀錄。
